...
from isaaclab_assets.robots.franka import FRANKA_PANDA_HIGH_PD_CFG, FRANKA_PANDA_REAL_ROBOT_CFG  # isort: skip
...
class FrankaCubeLiftEnvCfg(joint_pos_env_cfg.FrankaCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        # Override the cube scale here
        #self.scene.object.spawn.scale = (1.23, 1.23, 1.23)  # Change to desired scale
